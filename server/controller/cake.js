...
exports.getCake = async (req, res) => {
  try {
    ...
    const identifier = req.user ? { userId: req.user._id } : req.query.guestId ? { guestId: req.query.guestId } : null;
...
exports.deleteCake = async (req, res) => {
  try {
    ...
    const identifier = req.user ? { userId: req.user._id } : guestId ? { guestId } : null;
